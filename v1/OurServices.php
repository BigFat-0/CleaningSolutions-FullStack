...
<head>
  ...
  <link rel="preload" as="style" href="assets/mobirise/css/mbr-additional.css?v=LGfb51"><link rel="stylesheet" href="assets/mobirise/css/mbr-additional.css?v=LGfb51" type="text/css">
...
<body>
  ...
  <section data-bs-version="5.1" class="menu menu2 cid-tJS6tZXiPa" once="menu" id="menu02-2e">
...
<section data-bs-version="5.1" class="features3 cid-v4D9JmSqWh" id="features3-2s">
        ...
        <div class="row mt-4">
            <div class="item features-image col-12 col-md-6 col-lg-4 active">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/brookstick-703x1047.jpeg" alt="Mobirise Website Builder">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Moving In &amp; Out</strong></h5>
                        
                        <p class="mbr-text mbr-fonts-style mt-3 display-4">Relocating is stressful enough, let us handle the mess so your ready for the next chapter. </p>
                    </div>
                    <div class="mbr-section-btn item-footer mt-2"><a href="get_quote.php" class="btn item-btn btn-black-outline display-7">Enquire Now &gt;</a></div>
                </div>
            </div>
            <div class="item features-image col-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/still-life-office-cleaning-process-703x447.jpg" alt="Mobirise Website Builder">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><span style="font-size: 21.0896px;"><strong>Emergency</strong></span><strong>&nbsp;Cleaning</strong></h5>
            ...
            <div class="item features-image col-12 col-md-6 col-lg-4">
                <div class="item-wrapper">
                    ...
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Office Cleaning</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/front-view-woman-cleaning-home-703x468.jpg" alt="Mobirise Website Builder" data-slide-to="3" data-bs-slide-to="4">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Tailored Service</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/close-up-hand-with-rubber-glove-cleaning-window-703x527.jpg" alt="Mobirise Website Builder" data-slide-to="4" data-bs-slide-to="5">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Window Cleaning</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/person-wearing-yellow-rubber-boots-with-high-pressure-water-nozzle-cleaning-dirt-tiles-703x467.jpg" alt="Mobirise Website Builder" data-slide-to="5" data-bs-slide-to="4">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Pressure Washing</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/vertical-closeup-roof-drain-pipe-703x1007.jpg" alt="Mobirise Website Builder" data-slide-to="6" data-bs-slide-to="6">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Gutter Cleaning</strong></h5>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/people-housework-housekeeping-concept-close-up-woman-with-legs-vacuum-cleaner-cleaning-carpet-home-703x469.jpg" alt="Mobirise Website Builder" data-slide-to="7" data-bs-slide-to="7">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Carpet Cleaning</strong></h5>
...
<br><br></p>
                ...
                <div class="item-wrapper">
                    <div class="item-img">
                        <img src="assets/images/still-life-office-cleaning-process201-703x694.jpeg" alt="Mobirise Website Builder" data-slide-to="8" data-bs-slide-to="9">
                    </div>
                    <div class="item-content">
                        <h5 class="item-title mbr-fonts-style display-7"><strong>Airbnb Cleaning</strong></h5>
...
<section data-bs-version="5.1" class="footer4 cid-v4BbaHb6WW" once="footers" id="footer4-2f">
